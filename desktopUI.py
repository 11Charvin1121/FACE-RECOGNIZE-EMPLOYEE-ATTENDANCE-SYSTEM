...
def clear(id_var,fname_var,lname_var,address,wh_phone,gmailid,emp_dept_id,emp_dept_name):
                id_var.set("")
                fname_var.set("")
                lname_var.set("")
                address.set("")
...
def add_face_frame_fn():
        ...
        # call datacollector face 
            def calldatacollector():
                ...
                iamgetaker(data_id,data_name,data_lname,data_address,data_wh,data_gmail,data_dept_id,data_dept_name)
                clear( id_var, fname_var, lname_var, address, wh_phone, gmailid,deptid_var,deptname_var)
                # view_data(r)
...
def databse_frame_fn():
        ...
        record_view = ttk.Treeview(record_frame,columns=("ID","Dept_Id","Dept_name","NAME",'LastName','Address','WhatsappNumber','G-mail'),
                                   style="mystyle.Treeview",
                                   yscrollcommand=scroll_yaxis.set,
